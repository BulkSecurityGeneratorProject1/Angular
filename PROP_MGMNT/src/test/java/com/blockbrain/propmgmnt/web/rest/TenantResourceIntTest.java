...
public class TenantResourceIntTest {
    ...
    public void createTenant() throws Exception {
        ...
        assertThat(testTenant.getUniqueIdentifier()).isEqualTo(DEFAULT_UNIQUE_IDENTIFIER);
    ...
    public void checkUniqueIdentifierIsRequired() throws Exception {
        int databaseSizeBeforeTest = tenantRepository.findAll().size();
        // set the field null
        tenant.setUniqueIdentifier(null);
    ...
    public void getAllTenants() throws Exception {
        ...
        restTenantMockMvc.perform(get("/api/tenants?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].uniqueIdentifier").value(hasItem(DEFAULT_UNIQUE_IDENTIFIER.toString())))
    ...
    public void getTenant() throws Exception {
        ...
        restTenantMockMvc.perform(get("/api/tenants/{id}", tenant.getId()))
            ...
            .andExpect(jsonPath("$.uniqueIdentifier").value(DEFAULT_UNIQUE_IDENTIFIER.toString()))
    ...
    public void updateTenant() throws Exception {
        ...
        assertThat(testTenant.getUniqueIdentifier()).isEqualTo(UPDATED_UNIQUE_IDENTIFIER);
