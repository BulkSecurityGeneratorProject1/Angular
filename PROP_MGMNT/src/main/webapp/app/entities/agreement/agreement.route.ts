...
export class AgreementResolve implements Resolve<IAgreement> {
    ...
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot) {
        ...
        if (id) {
            return this.service.find(id).map((agreement: HttpResponse<Agreement>) => agreement.body);
        }
        return Observable.of(new Agreement());
    }
}
...
export const agreementRoute: Routes = [
    {
        ...
        data: {
            ...
            pageTitle: 'propMgmntApp.agreement.home.title'
        },
